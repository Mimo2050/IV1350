...
public class ItemRegistry {
	...
	private final Amount COLAPRICE = new Amount (20,"SEK");
	...
	private final String COLAID = "zxcv123";
	 ...
	 * @throws DatabasConnection 
	 */
	public ItemDTO findItem(String itemIdentifier) throws DatabasConnection {
		if (itemIdentifier.equals("qwr1234")){
			throw new DatabasConnection();
		}
	...
	private void addItem() {
		...
		items.add(new ItemDTO("COLA", COLAPRICE, VAT20PERCENT, COLAID));

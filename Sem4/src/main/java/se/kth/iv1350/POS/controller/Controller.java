...
public class Controller {
	    ...
	    public SaleDTO addItem(String itemIdentifier, int itemQuantity)throws InvalidItemIdentifierException, OperationFaliureException {
	    	...
	    	catch (ItemRegistryException | DatabasConnection exc) {
	    		throw new OperationFaliureException("unable to add item due to database connection failure , try again", exc);
	    	}
	    }
